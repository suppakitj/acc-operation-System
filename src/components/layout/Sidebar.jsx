...
import {
  ...
  HeartPulse, KeyRound, Globe, BookOpen, BookMarked, Home, ClipboardCheck, CalendarClock, FileBarChart, GraduationCap, FileText, ShieldAlert, Lightbulb
} from 'lucide-react';
...
export default function Sidebar({ user, collapsed, setCollapsed, mobileOpen, setMobileOpen, lineUnreadCount = 0 }) {
  ...
  const menuGroups = [
    ...
    { key: 'reports', label: 'ทีม & รายงาน', icon: BarChart3, ids: ['staff_dashboard', 'team_analytics', 'engagement_insights', 'obligation_dashboard', 'customer_summary', 'findings_dashboard', 'workload', 'staff_cost_report', 'forecast_risk'] },
