...
import {
  ...
  HeartPulse, KeyRound, Globe, BookOpen, BookMarked, Home, ClipboardCheck, CalendarClock, FileBarChart, GraduationCap, FileText
} from 'lucide-react';
...
export default function Sidebar({ user, collapsed, setCollapsed, mobileOpen, setMobileOpen }) {
  ...
  const menuGroups = [
    ...
    { key: 'reports', label: 'ทีม & รายงาน', icon: BarChart3, ids: ['staff_dashboard', 'team_analytics', 'engagement_insights', 'obligation_dashboard', 'customer_summary', 'workload', 'staff_cost_report', 'forecast_risk'] },
