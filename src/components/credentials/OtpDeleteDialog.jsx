...
export default function OtpDeleteDialog({ open, onOpenChange, credential, onDeleted }) {
  const [step, setStep] = useState('confirm'); // confirm | otp_verify
